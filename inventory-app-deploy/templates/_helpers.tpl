...
app.kubernetes.io/component: gitops-demo-inventory
app.kubernetes.io/part-of: gitops-demo-inventory
...
app: gitops-demo-inventory
app.kubernetes.io/name: gitops-demo-inventory
